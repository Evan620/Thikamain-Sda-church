...
const AdminHeader = ({ onMenuClick }) => {
  const { user, userProfile, signOut, getDisplayName, getRoleDisplay } = useAuth()
            ...
            {dropdownOpen && (
              <div className="admin-user-menu">
                <div className="admin-user-menu-header">
                  ...
                  <p className="admin-user-menu-email">
                    {user?.email}
                  </p>
                </div>
                ...
                >
                  <svg className="admin-menu-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
