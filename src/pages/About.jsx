          ...
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: isMobile ? '1.5rem' : '2rem' }}>
              <span style={{
                ...
                {isMobile ? 'Faith • Love' : 'Established in Faith • Growing in Love'}
              </span>
            </div>
            ...
            <h1 style={{
              ...
              }}>Thika Main</span> SDA Church
            </h1>

            {/* Description */}
            <div style={{
              maxWidth: '950px',
              margin: isMobile ? '0 auto 3rem auto' : '0 auto 4rem auto',
              ...
              <p style={{
                ...
                A vibrant community of believers committed to sharing God's love, truth, and hope
                with Thika and beyond.
              </p>
              <p style={{
                fontSize: '1.2rem',
                fontWeight: '300',
                ...
                Discover our rich heritage, mission, and the people who make our church family special.
              </p>
            </div>
