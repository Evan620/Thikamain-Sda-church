          ...
          <div className="footer-section">
            ...
            <div>
              ...
              <div className="footer-contact-item">
                ...
                <span>thikamainsdachurchclerk@gmail.com</span>
              </div>
              ...
              <div className="footer-contact-item">
                ...
                <span>thikamainsdachurch@yahoo.com</span>
              </div>
            </div>
            ...
            <div className="footer-social">
              ...
              <a href="https://www.youtube.com/@thikamainsdachurch" className="footer-social-link" title="Thika Main SDA Church YouTube" target="_blank" rel="noopener noreferrer">
                <svg style={{ width: '1.25rem', height: '1.25rem' }} fill="currentColor" viewBox="0 0 24 24">
